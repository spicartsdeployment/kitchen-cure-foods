      ...
      <div className="min-h-screen py-10 px-4 mt-10">
        <div className="max-w-6xl container mx-auto mt-8">
          <div className="bg-white p-6">
            ...
            <div className="p-8 border border-gray-200 rounded-2xl shadow-md">
              <div className="py-4">
                <h3 className="text-xl text-center font-medium py-2">
                  Overview
                </h3>
                <div className="font-light text-sm">
                  <p className="mb-4">
                    Welcome to Kitchen Cure Foods! These terms and conditions
                    outline the rules and regulations for the use of our website
                    and services. By accessing this website, we assume you
                    accept these terms and conditions in full. Do not continue
                    to use Kitchen Cure Foods if you do not accept all of the
                    terms and conditions stated on this page.
                  </p>
                  <p className="mb-4">
                    By visiting our site and/ or purchasing something from us,
                    you engage in our “Service” and agree to be bound by the
                    following terms and conditions (“Terms & Conditions”,
                    “Terms”), including those additional terms and conditions
                    and policies referenced herein and/or available by
                    hyperlink. These Terms & Conditions apply to all users of
                  ...
                  <p className="mb-4">
                    ...
                    website or use any services. If these Terms & Conditions are
                    considered an offer, acceptance is expressly limited to
                    these Terms & Conditions.
                  </p>
                  <p className="mb-4">
                    Any new features or tools which are added to the current
                    store shall also be subject to the Terms & Conditions. You
                    can review the most current version of the Terms &
              ...
              <p className="font-light text-sm mb-4">
                Unless otherwise stated, Kitchen Cure Foods and/or its licensors
                own the intellectual property rights for all material on Kitchen
                Cure Foods. All intellectual property rights are reserved. You
                may view and/or print pages from https://kitchencurefoods.com
                for your own personal use subject to restrictions set in these
                terms and conditions.
              </p>
              <h3 className="text-lg font-semibold mb-2">2. User Comments</h3>
              <p className="font-light text-sm mb-4">
                Certain parts of this website offer the opportunity for users to
                post and exchange opinions, information, material, and data
                ('Comments'). Kitchen Cure Foods does not screen, edit, publish
                or review Comments prior to their appearance on the website and
                Comments do not reflect the views or opinions of Kitchen Cure
                Foods, its agents, or affiliates. Comments reflect the view and
                opinion of the person who posts such view or opinion. To the
                extent permitted by applicable laws Kitchen Cure Foods shall not
                be responsible or liable for the Comments or for any loss cost,
              ...
              <p className="font-light text-sm mb-4">
                We strive to ensure that all product information on our website
                is accurate and up-to-date. However, we do not warrant that
                product descriptions, prices, or other content on the website
                are accurate, complete, reliable, current, or error-free. We
              ...
              <p className="font-light text-sm mb-4">
                In no event shall Kitchen Cure Foods, nor any of its officers,
                ...
                Kitchen Cure Foods, including its officers, directors, and
              ...
              <p className="font-light text-sm mb-4">
                ...
                <span className="font-semibold text-md hover:underline ml-1">
                  <a href="mailto:admin@kcf.com">admin@kcf.com</a>
                </span>
                . Our helpline number{" "}
                <span className="font-semibold text-md hover:underline">
                  <a href="tel:+917337292216">+91 7337292216</a>
                </span>{" "}
                to reach out for any queries.
              </p>
            </div>
          </div>
        </div>
